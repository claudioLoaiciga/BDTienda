...
<div class="card col-lg-12 mx-auto p-6 animate-in-down">
    <div class="card-header">
        <div class="container">
            <h1 class="page-header">Sistema de Facturación</h1>
            <form method="POST" action="?c=Factura&a=Guardar" enctype="multipart/form-data"  id="factura" name="factura">
                ...
                <div class="cbp-mc-form">
                    <div class="cbp-mc-column">
                        <label>Cliente:</label>
                        <input class="form-control" required="" readonly="readonly" value="1" id="txtCliente" name="txtCliente" />
                        <button type="button" id="botonGuardar" class="btn btn-primary" style="margin-top: 5px" data-toggle="modal" data-target="#exampleModalCentered">
                            Buscar Cliente
                        </button>
                    </div>
                    <div class="cbp-mc-column">
                        <label>Fecha:</label>
                        <input class="form-control" readonly="readonly" type="text" id="txtfecha" name="txtfecha" value="<?php echo date("j/n/Y"); ?>" />
                    </div>
                ...
                <div>
                    <h2>Productos</h2>
                    <input class="form-control" required type="hidden" id="txtDireccion" name="txtDireccion" value="NINGUNO" placeholder="ingrese la direccion" />
                ...
                <div>
                    ...
                    <div>
                        ...
                        <button id="botonGuardar" class="btn btn-success"><a href="index.php?c=Factura" style="color: white;">Cancelar</a></button>
                            ...
                            <tbody>
                                <?php foreach ($this->modelProducto->ListarProductos() as $emple) : ?>
                                    <tr>
                                        ...
                                        <td><input class="form-control" type="number" name="cantidad_" id="cantidad_<?php echo $emple->codigo; ?>" value="1"></td>
